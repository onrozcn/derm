...
var KTQuickSearch = function() {
    ...
    var processSearch = function() {
        ...
        setTimeout(function() {
            $.ajax({
                url: 'https://keenthemes.com/metronic/tools/preview/api/quick_search.phpQ',
                data: {
                    query: query
                },
                dataType: 'html',
                ...
                error: function(res) {
                    ...
                    hideProgress();
                    KTUtil.addClass(target, resultClass);
                    KTUtil.setHTML(resultWrapper, '<span class="kt-quick-search__message">Bağlantı hatası. Lütfen daha sonra tekrar deneyin.</div>');
                    showDropdown();
                    KTUtil.scrollUpdate(resultWrapper);
                }
            });
