...
checkPermissionPage(array('superadmin', 'admin', 'depRaporCikisPageView'));
?>
<!DOCTYPE html>
<html lang="tr">
<!-- begin::Head -->
                                    ...
                                    <div class="kt-portlet">
                                        <div class="kt-portlet__head">
                                            <div class="kt-portlet__head-label">
                                                <span class="kt-portlet__head-icon"><i class="fad fa-file-chart-column"></i></span>
                                                <h3 class="kt-portlet__head-title">Yakıt Çıkış Rapor</h3>
                                            </div>
                                        ...
                                        <div class="kt-portlet__body">
                                                    ...
                                                    <div class="col-lg-6 col-xl-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="date" class="form-control" id="start_date" name="start_date" value="<?=date("Y-m-01");?>" step="0" autocomplete="off"/>
                                                                <input type="date" class="form-control" id="end_date" name="end_date" value="<?=date("Y-m-d");;?>" step="0" autocomplete="off"/>
                                                                <div class="input-group-append">
                                                                    <select class="form-control input-group-text" id="status" name="status">
                                            ...
                                            <div id="DepoRaporCikisTablo"></div>
...
<script src="assets/js/pages/depRaporCikis.js?v=<?=$siteJsVersion?>" type="text/javascript"></script>
<!--end::Page Scripts -->
